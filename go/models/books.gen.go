...
func newBook(db *gorm.DB, opts ...gen.DOOption) book {
	...
	_book.Year = field.NewInt32(tableName, "year")
	_book.Prize = field.NewFloat32(tableName, "prize")
	...
	_book.Availability = field.NewInt32(tableName, "Availability")
...
func (b *book) updateTableName(table string) *book {
	...
	b.Prize = field.NewFloat32(table, "prize")
	...
	b.Availability = field.NewInt32(table, "Availability")
