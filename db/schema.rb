...
ActiveRecord::Schema.define(version: 2024_06_22_150456) do
  ...
  create_table "borrowing_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "books_id"
    t.bigint "users_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "returned_at"
    t.index ["books_id"], name: "index_borrowing_records_on_books_id"
    t.index ["users_id"], name: "index_borrowing_records_on_users_id"
  end
